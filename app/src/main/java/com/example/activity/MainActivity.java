        ...
        button_red.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_red.getText().equals("Red")) {
                    ...
                    Toast.makeText(MainActivity.this, "Color successfully changed to red", Toast.LENGTH_LONG).show();
                }
            }
        });
        button_blue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_blue.getText().equals("Blue")) {
                    ...
                    Toast.makeText(MainActivity.this, "Color successfully changed to blue", Toast.LENGTH_LONG).show();
                }
            }
        });
        button_green.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_green.getText().equals("Green")) {
                    ...
                    Toast.makeText(MainActivity.this, "Color successfully changed to green", Toast.LENGTH_LONG).show();
                }
            }
        });
        button_violet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_violet.getText().equals("Violet")) {
                    ...
                    Toast.makeText(MainActivity.this, "Color successfully changed to violet", Toast.LENGTH_LONG).show();
                }
            }
        });
        button_yellow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (button_yellow.getText().equals("Yellow")) {
                    ...
                    Toast.makeText(MainActivity.this, "Color successfully changed to yellow", Toast.LENGTH_LONG).show();
                }
            }
        });
